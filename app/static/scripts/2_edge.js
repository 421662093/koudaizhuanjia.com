                    ...
                    dom: [
                        {
                            ...
                            fill: ["rgba(0,0,0,0)",im+"%E5%9C%883%401x.png",'0px','0px']
                        },
                        {
                            id: '_21x',
                            type: 'image',
                            ...
                            opacity: '0',
                            fill: ["rgba(0,0,0,0)",im+"%E5%9C%882%401x.png",'0px','0px']
                        },
                        {
                            id: '_11x',
                            type: 'image',
                            ...
                            opacity: '0.2',
                            fill: ["rgba(0,0,0,0)",im+"%E5%9C%881%401x.png",'0px','0px']
                        },
                        {
                            id: '_1x',
                            type: 'image',
                            ...
                            opacity: '1',
                            fill: ["rgba(0,0,0,0)",im+"%E5%9C%88%401x.png",'0px','0px']
                        },
                        {
                            id: '_1x2',
                            type: 'image',
                            rect: ['276px', '278px', '209px', '208px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"%E6%94%BE%E5%A4%A7%E5%A2%83%401x.png",'0px','0px']
                        },
                        {
                            id: '_1x3',
                            type: 'image',
                            ...
                            opacity: '0',
                            fill: ["rgba(0,0,0,0)",im+"%E5%AF%B9%E8%AF%9D%401x.png",'0px','0px']
                        },
                        {
                            id: '_1x32',
                            type: 'image',
                            rect: ['841px', '-248px', '475px', '149px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"%E5%B7%A5%E4%BD%9C%401x3.png",'0px','0px']
                        }
                    ],
                    style: {
                        '${Stage}': {
